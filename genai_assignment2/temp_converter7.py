...
# display options to the user to convert temperatures between Celsius, Fahrenheit, and Kelvin.
while True:
    print("\n=== TEMPERATURE CONVERTER ===")
    ...
    if choice == "7":
        print("Exit program.")
        break
# take user input for temperature based on their choice and perform the conversion using appropriate formulas.
    try:
        if choice == "1":
